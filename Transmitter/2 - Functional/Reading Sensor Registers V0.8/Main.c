...
int main(void)
{
    ...
    //bmm150_set_sensor_settings(BMM150_SEL_DATA_RATE, &mySettings, &dev);
      ...
      //bmm150_user_i2c_reg_write(0x4c, 0x06, 1, 0);
      
      //bmm150_user_i2c_reg_read(0x4c, &tempDataStorage, 1, 0); // Added Pointer to array

      //writeRegister(0x4b, 0x83);  //  SOFT  RESET
      
      writeRegister(0x4b, 0x01);    //  POWER CONTROL BIT,  ON

      //writeRegister(0x4c, 0x06);    //  SET   OP  MODE
    

    while(true){

    //bmm150_user_i2c_reg_read(0x4F, &tempDataStorage, 1, 0);
    //bmm150_user_i2c_reg_read(0x4E, &tempDataStorage, 1, 0);
    //bmm150_user_i2c_reg_read(0x4D, &tempDataStorage, 1, 0);
    //bmm150_user_i2c_reg_read(0x4C, &tempDataStorage, 1, 0);
    //bmm150_user_i2c_reg_read(0x4B, &tempDataStorage, 1, 0);
    //bmm150_user_i2c_reg_read(0x4A, &tempDataStorage, 1, 0);

    bmm150_get_regs(0x4C, &tempDataStorage, 1, &dev);
